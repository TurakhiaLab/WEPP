...
def write_sam_files(input_sam_file):
    write_file_sam = os.path.join(results_directory, f"{file_prefix}_haplotype_reads.sam")
    write_file_bam = os.path.join(results_directory, f"{file_prefix}_haplotype_reads.bam")
