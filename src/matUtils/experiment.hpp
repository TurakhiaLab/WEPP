...
int place_reads(const MAT::Tree &, const std::vector<MAT::Node*> &, struct read_info*, const MAT::Node*, const std::unordered_map<std::string, double> &, tbb::concurrent_hash_map<MAT::Node*, double> &, const bool, const int);
