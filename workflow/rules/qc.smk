...
rule qc:
    ...
    shell:
        ...
        python src/qc_preprocess.py --platform {params.seq_type} --primers {params.primer_bed} --in $in_path --out $out_path --threads {threads} --reference wuhan.fa --prefix {wildcards.file_prefix}
        """