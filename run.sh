...
#matUtils haplotype_pruning -i public-2021-05-31.all.masked.nextclade.pangolin.pb -w public-2021-05-31.all.masked.nextclade.pangolin_pruned.pb -s remove_sample.txt -d 5
...
matUtils place_read -T 48 -i public-2021-05-31.all.masked.nextclade.pangolin.pb -j public-2021-05-31.all.masked.nextclade.pangolin.pb -l B.1.1.155,A.21,AE.6,B.1.1.285,B.1.1.47,B.1.567,B.35,U.1,C.27 -d 0.1,0.1,0.15,0.15,0.2,0.05,0.1,0.05,0.1 -v my_vcf -r 150 -w 20 -e 0 -s 100 -f test/NC_045512v2.fa
